module.exports = class Data1750446850208 {
    name = 'Data1750446850208'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "wallet_stats" ("id" character varying NOT NULL, "volume_sol" numeric NOT NULL, "realised_pnl_sol" numeric NOT NULL, "buy_sol" numeric NOT NULL, "sell_sol" numeric NOT NULL, "success_tokens_count" numeric NOT NULL, "token_count" numeric NOT NULL, "last_trade_ts" TIMESTAMP WITH TIME ZONE NOT NULL, CONSTRAINT "PK_384535b6a62652a7ae575c2b48e" PRIMARY KEY ("id"))`)
        await db.query(`CREATE TABLE "wallet_token_stats" ("id" character varying NOT NULL, "wallet" text NOT NULL, "volume_sol" numeric NOT NULL, "realised_pnl_sol" numeric NOT NULL, "buy_sol" numeric NOT NULL, "sell_sol" numeric NOT NULL, "first_trade_ts" TIMESTAMP WITH TIME ZONE NOT NULL, "last_trade_ts" TIMESTAMP WITH TIME ZONE NOT NULL, "first_trade_sol" numeric NOT NULL, "last_trade_sol" numeric NOT NULL, "token_id" character varying, CONSTRAINT "PK_a7eff7df52b2d1b0b05b2c72ddd" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_04332aaab2784cc151e8e10abb" ON "wallet_token_stats" ("token_id") `)
        ...
        await db.query(`ALTER TABLE "wallet_token_stats" ADD CONSTRAINT "FK_04332aaab2784cc151e8e10abb3" FOREIGN KEY ("token_id") REFERENCES "pump_token"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
    ...
    async down(db) {
        ...
        await db.query(`DROP TABLE "wallet_stats"`)
        await db.query(`DROP TABLE "wallet_token_stats"`)
        await db.query(`DROP INDEX "public"."IDX_04332aaab2784cc151e8e10abb"`)
        ...
        await db.query(`ALTER TABLE "wallet_token_stats" DROP CONSTRAINT "FK_04332aaab2784cc151e8e10abb3"`)
